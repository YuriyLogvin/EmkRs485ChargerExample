...
Stm32UsartDma* Hal::Usart;
Stm32UsartDma* Hal::Rs485;
...
void Hal::Init()
{
	Usart = new Stm32UsartDma(&huart1, 0x200, 0x100);
	Rs485 = new Stm32UsartDma(&huart2, 0x200, 0x100, Rs485En_GPIO_Port, Rs485En_Pin);
